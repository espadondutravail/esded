...
import sty from "./PlasmicProduct.module.css"; // plasmic-import: V58KfADfW6w8/css
  ...
  const new$Queries: Record<string, ReturnType<typeof usePlasmicDataOp>> = {
    revenueByDateRange: usePlasmicDataOp(() => {
      return {
        ...
        opId: "e50bcf8f-ae29-4ce0-b224-049343b686ad",
        userArgs: {
          query: [$state.start.value, $state.end.value]
        },
        cacheKey: `plasmic.$.e50bcf8f-ae29-4ce0-b224-049343b686ad.$.`,
    ...
    topProductsByQuantityLastYear: usePlasmicDataOp(() => {
      return {
        sourceId: "5h6zaT82WL1WhJ29jkzSY3",
        opId: "9225a3aa-1757-494e-988f-2d6ea3ce24be",
        userArgs: {
          query: [$state.start.value, $state.end.value]
        },
        cacheKey: `plasmic.$.9225a3aa-1757-494e-988f-2d6ea3ce24be.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    }),
    totalProductCountByDateRange: usePlasmicDataOp(() => {
      return {
        sourceId: "5h6zaT82WL1WhJ29jkzSY3",
        opId: "9b6544c5-ced6-4ad3-9126-f04026befc39",
        userArgs: {
          query: [$state.start.value, $state.end.value]
        },
        cacheKey: `plasmic.$.9b6544c5-ced6-4ad3-9126-f04026befc39.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    }),
    unitsSoldByDateRange: usePlasmicDataOp(() => {
      return {
        sourceId: "5h6zaT82WL1WhJ29jkzSY3",
        opId: "88baf468-82f2-4499-bf37-861d7ec9b2c5",
        userArgs: {
          query: [$state.start.value, $state.end.value]
        },
        cacheKey: `plasmic.$.88baf468-82f2-4499-bf37-861d7ec9b2c5.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    }),
    listAllProductNames: usePlasmicDataOp(() => {
      return {
        sourceId: "5h6zaT82WL1WhJ29jkzSY3",
        opId: "597df186-c636-4be7-86b9-fffacab9d50d",
        userArgs: {},
        cacheKey: `plasmic.$.597df186-c636-4be7-86b9-fffacab9d50d.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    })
            ...
            <DataCtxReader__>
              {$ctx => (
                <React.Fragment>
                  ...
                  <section
                    className={classNames(projectcss.all, sty.section__aofRp)}
                  >
                    <DateTimeRangePicker
                    ...
                    <Stack__
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__cznGs)}
                    >
                      <Statistic
                        className={classNames(
                          "__wab_instance",
                          sty.statistic__vhp4F
                        )}
                        ...
                        unit={
                          ...
                          >
                            ...
                            <PlasmicImg__
                              alt={""}
                              className={classNames(sty.img__jYYjn)}
                              displayHeight={"auto"}
                      ...
                      <Statistic
                        ...
                        unit={
                          ...
                          >
                            ...
                            <PlasmicImg__
                              alt={""}
                              className={classNames(sty.img__xzqob)}
                              displayHeight={"auto"}
                              displayMaxHeight={"28px"}
                              displayMaxWidth={"28px"}
                              displayMinHeight={"0"}
                      ...
                      <Statistic
                        ...
                        unit={
                          ...
                          >
                            ...
                            <PlasmicImg__
                              alt={""}
                              className={classNames(sty.img__sWik4)}
                              displayHeight={"auto"}
                              displayMaxHeight={"28px"}
                              displayMaxWidth={"28px"}
                              displayMinHeight={"0"}
                  ...
                  <section
                    className={classNames(projectcss.all, sty.section__aHqen)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__byLsr)}
                    >
                      <h2
                        className={classNames(
                          projectcss.all,
