...
import sty from "./PlasmicDateTimeRangePicker.module.css"; // plasmic-import: fE0U6OCFCawv/css
            ...
            <React.Fragment>
              {(() => {
                const child$Props = {
                  ...
                  className: classNames(
                    "__wab_instance",
                    sty.dateTimePicker__cRBjv
                  ),
                  picker: "date",
                  popupScopeClassName:
                    sty["dateTimePicker__cRBjv__datePickerPopup"],
                  showTime: false
                };
              ...
              {(() => {
                const child$Props = {
                  ...
                  className: classNames(
                    "__wab_instance",
                    sty.dateTimePicker___38RjN
                  ),
                  popupScopeClassName:
                    sty["dateTimePicker___38RjN__datePickerPopup"],
                  showTime: false
                };
