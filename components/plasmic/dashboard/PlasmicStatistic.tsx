...
import sty from "./PlasmicStatistic.module.css"; // plasmic-import: qpvwlkqzYTfT/css
...
function PlasmicStatistic__RenderFunc(props: {
  ...
  return (
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__sAhil)}>
            <p
              className={classNames(
                projectcss.all,
                projectcss.p,
            ...
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__s5Ad4, {
                [sty.imghideIcon__s5Ad4WkauH]: hasVariant(
                  $state,
                  "hideIcon",
                  "hideIcon"
                )
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__xS4Ub)}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__mRkj, {
            [sty.freeBoxhideIcon__mRkjWkauH]: hasVariant(
              $state,
              "hideIcon",
              "hideIcon"
            )
        ...
        <div className={classNames(projectcss.all, sty.freeBox__lJj42)}>
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__vIxE5, {
              [sty.freeBoxhideTrendTracker__vIxE5RDgoW]: hasVariant(
                $state,
                "hideTrendTracker",
                "hideTrendTracker"
              )
          ...
          >
            <div
              className={classNames(projectcss.all, sty.freeBox___1VSvB, {
                [sty.freeBoxhideTrendTracker___1VSvBrDgoW]: hasVariant(
                  $state,
                  "hideTrendTracker",
                  "hideTrendTracker"
                )
            ...
            >
              <div className={classNames(projectcss.all, sty.freeBox__i2Ib1)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.freeBox__hh4UI)}>
              <div className={classNames(projectcss.all, sty.freeBox__wiw6A)}>
                {renderPlasmicSlot({
